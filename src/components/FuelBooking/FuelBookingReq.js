...
function FuelBookingReqs() {
  ...
  const modifyBkg = (id, status) => {
    ...
    axios
      .put(`http://localhost:5000/fuelBookingRequests/update/${id}`, updatedBkg)
      .then((res) => {
  ...
  const getBookings = (id) => {
    axios
      .get(`http://localhost:5000/fuelBookingRequests/${id}`)
      .then((res) => {
    ...
    return (
      <div>
        ...
        >
          ...
          <BsArrowCounterclockwise
            size={70}
            style={{ backgroundColor: "darkgrey", borderRadius: "7px" }}
            onClick={reloadPage}
          />
        </div>
      </div>
    ...
    return (
      <div>
        ...
        >
                      ...
                      <tr>
                        ...
                        <td>
                          <BsCheckSquareFill
                            ...
                            onClick={() => {
                              modifyBkg(booking._id, "Approved");
                            }}
                          />{" "}
                          Approve
                          <BsFileExcelFill
                            ...
                            onClick={() => {
                              modifyBkg(booking._id, "Rejected");
                            }}
                          />{" "}
                          Reject
                        </td>
          ...
          <div style={{ fontSize: "20px" }} onClick={printDocument}>
            Download as a pdf <BsFileEarmarkPdf size={40} />
          </div>
        </div>
      </div>
    );

...
function UpdateBooking() {
  ...
  const Stations = [
    { value: "Eheliyagoda Associates", label: "Eheliyagoda Associates" },
    { value: "Ss Kotalawala P Ltd", label: "Ss Kotalawala P Ltd" },
    { value: "Alliance Enterprises", label: "Alliance Enterprises" },
    {
      value: "Ben Hewa Associates(pvt)ltd",
      label: "Ben Hewa Associates(pvt)ltd",
    },
  ];
  ...
  function UpdateBkg(e) {
    ...
    axios
      .put(`http://localhost:5000/fuelBookings/update/${id}`, updatedBkg)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/fuelBookings/get/${id}`)
      .then((res) => {
        console.log(res.data);
              ...
              <form onSubmit={UpdateBkg}>
                ...
                <div class="form-group">
                  ...
                  <TextField
                    ...
                    helperText="Please select the filling station"
                    fullWidth
                    variant="standard"
                    style={{
                      marginLeft: "10px",

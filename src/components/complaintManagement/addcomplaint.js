        ...
        >
          <div className="card-body">
            <p className="card-text" style={{ textAlign: "left" }}>
              {" "}
              Please Send us details about the inceident you would like to
              report. Our Complaint Center will analyze your complaint and take
              the appropriate measure in order that the reported situation will
              not oocur at any time the future.
            </p>
            <hr />
            <div>
              <form onSubmit={submitComplaint}>
                <div class="form-group">
                  ...
                  <input
                    ...
                    title="follow requested format Ex:([name@example.com])"
                    required="required"
                  />
                </div>
                <br></br>
                <div class="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setdateofComplaint(e.target.value);
                    }}
                    type="date"
                    class="form-control"
                    id="exampleFormControlInput1"
                ...
                <div class="form-group">
                  ...
                  <textarea
                    ...
                    rows="3"
                    placeholder="Please enter your message briefly."
                    required
                  ></textarea>
                  <div>
                    {sucessfull !== false && (
                      <p style={{ color: "red", float: "left" }}>
                        Please enter more than 10 letters
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div class="form-group">
                  <button
                    style={{ width: "100%", backgroundColor: "#ff762e" }}
                    type="submit"
